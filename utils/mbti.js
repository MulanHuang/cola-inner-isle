// MBTI 测试工具函数
// 已移动到主包，解决跨分包 require 问题

// 题库：包装成 JS 模块，避免直接 require .json 在部分环境下失败
// 注意：题库数据也需要放在主包中，否则主包无法引用分包的模块
// B版：传统版题库（70题）
const questionsDataB = require("./data/mbtiQuestions.js");
// A版：最新版题库（60题，更接近官方）
const questionsDataA = require("./data/mbtiQuestionsA.js");
